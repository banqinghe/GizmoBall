...
export default class Circle {
    ...
    changeV(ball){
        ...
        //作图可得,与圆心连线垂直的直线与x正方向夹角满足  tan angle = (x1 - x2) / (y1 - y2),需要特判 y1 = y2的情况
        let lineAngle = ballMiddleY != this.middleY?Math.acos(0) : Math.atan((ballMiddleX - this.middleX) / (ballMiddleY - this.middleY));
